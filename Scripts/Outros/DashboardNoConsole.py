...
tipo_financiamento = prompt.ask('Qual financiamento deseja contratar?',choices=['12x', '36x', '72x'])
nome = input('Digite seu nome para finalizar: ')
print(f'[on blue][black]Parabéns [white]{nome}[/], você escolheu o financiamento de [green]{tipo_financiamento}[/][/][/]')